...
mysql = MySQLdb.connect (host = sql_host,
                         user = sql_user,
                         passwd = sql_hostpass,
                         db = sql_db)
cursor = mysql.cursor()
...
while True:
    inctext = irc.recv(4096).split('\n')
    textcounter = 0
    while(textcounter < len(inctext)):
        try:
            text = inctext[textcounter]
            if len(text) > 0:
                print text
            data = text.split()
                ...
                if lengtv >= 0:
                    ...
                    if newtime >= gtvtime:
                        if gtv1[3] != '':
                            ...
                            irc.send('PRIVMSG ' + privchan + ' :A GTV server isn\'t set.\n')

                else:
                    stop = 1
                    if result == 1:
                        irc.send('PRIVMSG ' + pubchan + ' :' + gtvspam1 + '\n')
                        irc.send('PRIVMSG ' + pubchan + ' :' + gtvspam + '\n')
                        irc.send('PRIVMSG ' + privchan + ' :GTV spammed\n')
                lengtv = lengtv - 1
            ...
            if "PRIVMSG" in text:
                ...
                if data[3] == ":!gtv":
                    ...
                    if data[2] == privchan or data[2] == altchan:
                        if len(data) <= 4:
                        ...
                        elif data[4] == "delete" and data[2] == privchan:
                            cursor.execute("SELECT * FROM gtv_sc WHERE ID='" + data[5] + "' AND not Done='yes'")
                            ...
                            if not gtv1 == None:
                                ...
                                irc.send('PRIVMSG ' + channel + ' :ERROR appeared: !gtv delete <id>\n')
                        ...
                        elif data[4] == "topic" and data[2] == privchan:
                            if len(data) >= 6:
                                    if data [5] == "default":
                        ...
                        elif data[4] == "adv" and data[2] == privchan:
                            if len(data) >= 6:
                                    stop = 0
                                    num = 5
                                    what = ""
                            ...
                            if len(data) >= 6:
                                ...
                                if ident_user in admins:
                                    ...
                                    while(stop < 1):
                                        ...
                                        if int(num) == int(lenge):
                                            stop = 1
                                    irc.send('PRIVMSG ' + pubchan + ' :' + str(what) + '\n')
                        ...
                        elif data[4] == "autospam" and data[2] == privchan:
                            if len(data) == 7:
                                if data[6] == "on":
                        ...
                        elif data[4] == "spam" and data[2] == privchan:
                            cursor.execute("SELECT status FROM status_new WHERE Name='ts3'")
                            ts3 = cursor.fetchone()
                            if len(data) == 6:
                                if data[5].isdigit() == True:
                                    ...
                                    if not gtv1 == None:
                                        if gtv1[3] != "":
                                            ...
                                            msg = ""
                                        irc.send('PRIVMSG ' + pubchan + ' :!gtvmsg Watch Now! ' + gtv1[0] + ' vs ' + gtv1[1] + ' - /connect ' + gtv1[2] + msg + '\n')
                                        irc.send('PRIVMSG ' + pubchan + ' :!msg [GTV] Watch Now! ' + gtv1[0] + ' vs ' + gtv1[1] + ' - /connect ' + gtv1[2] + msg + '\n')
                                ...
                                if data[5].isdigit() == True and data[6].isdigit() == True:
                                    ...
                                    if not gtv1 == None and not gtv2 == None:
                                        ...
                                        if gtv2[3] != "":
                                            ...
                                            msg2 = ""
                                        irc.send('PRIVMSG ' + pubchan + ' :!gtvmsg Watch Now! ' + gtv1[0] + ' vs ' + gtv1[1] + ' - /connect ' + gtv1[2] + msg1 + ' | ' + gtv2[0] + ' vs ' + gtv2[1] + ' - /connect ' + gtv2[2] + msg2 + '\n')
                                        irc.send('PRIVMSG ' + pubchan + ':!msg [GTV] Watch Now! ' + gtv1[0] + ' vs ' + gtv1[1] + ' - /connect ' + gtv1[2] + msg1 + ' | ' + gtv2[0] + ' vs ' + gtv2[1] + ' - /connect ' + gtv2[2] + msg2 + '\n')
                                        cursor.execute("UPDATE gtv_sc SET Spam='2' WHERE ID='" + str(gtv1[0]) + "'")
                            ...
                            if len(data) == 6:
                                ...
                                irc.send('PRIVMSG ' + channel + ' :ERROR appeared: !gtv remove <id>\n')

                if data[3] == ":!sc":
                    channel = data[2]
                    if data[2] == altchan or data[2] == privchan:
                        if len(data) <= 4:
                            pass
                            ...
                            elif len(data) == 7:# and data[2] == privchan:
                                cursor.execute("SELECT * FROM gtv_sc WHERE ID='" + data[5] + "' AND NOT Who=''")
                                gtv1 = cursor.fetchone()
                                if not gtv1 == None:
                                    cursor.execute("UPDATE gtv_sc SET Shoutcaster='" + str(data[6]) + "' WHERE id='" + str(data[5]) + "'")
